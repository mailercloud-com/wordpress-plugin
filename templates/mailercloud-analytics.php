...
<div class="wrap mailercloud-analytics">
    ...
    <div style="background:#fff;border:1px solid #ccd0d4;padding:20px;margin:16px 0;max-width:820px;">
        <h2 style="margin:0;font-size:32px;"><?php echo esc_html(number_format_i18n($total_captured)); ?></h2>
        <p style="margin:0;color:#555;"><?php esc_html_e('Total contacts captured by this plugin', 'mailercloud'); ?></p>
    </div>
    ...
    <?php else : ?>
        <table class="widefat striped" style="max-width:820px;">
            <thead><tr>
                ...
                <th><?php esc_html_e('Failed', 'mailercloud'); ?></th>
            </tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo esc_html(number_format_i18n(isset($row['fail']) ? intval($row['fail']) : 0)); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
